    ...
    void QMI8658::config_acc(enum qmi8658_AccRange range, enum qmi8658_AccOdr odr, enum qmi8658_LpfConfig lpfEnable, enum qmi8658_StConfig stEnable) {
        ...
        switch (range) {
            case Qmi8658AccRange_2g:
                g_imu.ssvt_a = (1 << 14);
            break case Qmi8658AccRange_4g:
                g_imu.ssvt_a = (1 << 13);
            break case Qmi8658AccRange_8g:
                g_imu.ssvt_a = (1 << 12);
            break case Qmi8658AccRange_16g:
                g_imu.ssvt_a          = (1 << 11);
                break default : range = Qmi8658AccRange_8g;
                g_imu.ssvt_a          = (1 << 12);
        }
    ...
    void QMI8658::config_gyro(enum qmi8658_GyrRange range, enum qmi8658_GyrOdr odr, enum qmi8658_LpfConfig lpfEnable, enum qmi8658_StConfig stEnable) {
        ...
        switch (range) {
            case Qmi8658GyrRange_16dps:
                g_imu.ssvt_g = 2048;
            break case Qmi8658GyrRange_32dps:
                g_imu.ssvt_g = 1024;
            break case Qmi8658GyrRange_64dps:
                g_imu.ssvt_g = 512;
            break case Qmi8658GyrRange_128dps:
                g_imu.ssvt_g = 256;
            break case Qmi8658GyrRange_256dps:
                g_imu.ssvt_g = 128;
            break case Qmi8658GyrRange_512dps:
                g_imu.ssvt_g = 64;
            break case Qmi8658GyrRange_1024dps:
                g_imu.ssvt_g = 32;
            break case Qmi8658GyrRange_2048dps:
                g_imu.ssvt_g = 16;
                break

                    default : range = Qmi8658GyrRange_512dps;
                g_imu.ssvt_g        = 64;
                break
        }
